...
本仓库是一个模块化的 C/C++ 学习与实践指南，旨在通过可运行的精简示例、直观的心智模型（物理类比）以及统一的 CMake 构建系统，深度解析 C/C++ 的核心语言机制与系统级底层原理。
...
| **arithmetic-traps** | C/C++ 算术运算潜规则：整型提升与寻常算术转换 | 无 | [链接](https://www.youtube.com/watch?v=TKQPuLyozTg) | [链接](https://www.bilibili.com/video/BV1YTKS6VE7x) |
...
| **build-type** | C/C++ 构建类型的底层原理与工程取舍，以及裸机交叉编译的全链路解析 | dynamic-static-libs | [链接](https://www.youtube.com/watch?v=pkbxrxwJslo&t=446s) | [链接](https://www.bilibili.com/video/BV1i7ofBNExr) |
---
